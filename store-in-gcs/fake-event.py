...
Examples:
  ...
  python %(prog)s \\
    ...
    parser.add_argument("--project", default="pennantchase-256-dev", help="GCP Project ID")
    parser.add_argument("--location", default="us-central1", help="GCP location/region")
    parser.add_argument("--database", default="'(default)'", help="Firestore database ID")
    parser.add_argument("--collection", default="mydb", help="Collection path")
    parser.add_argument("--document", default="doc123", help="Document ID")
